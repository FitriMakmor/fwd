<x-app-layout>
    ...
    <div class="progress">
        <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="25"
    ...
    <div class="card my-4">
        <div class="card-body d-flex justify-content-center">
            ...
            <h4>
                <form style="font-size: 1.5rem;" action="" method="POST">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <label class="btn btn-secondary w-50" for="male">Male</label>
                        <input type="radio" class="btn-check btn-gender" name="gender" id="female" autocomplete="off">
                        <label class="btn btn-secondary w-50" for="female">Female</label>
                    </div>
